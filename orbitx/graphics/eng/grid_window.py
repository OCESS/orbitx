...
class GridPage(ttk.Frame):
    ...
    def __init__(self, parent: ttk.Widget):
        ...
        widgets.RadShieldFrame(self, coords=background.widget_coords(strings.RADS1), text_function=lambda state: f"{state.rad_shield_percentage:,} %")
        widgets.RadShieldFrame(self, coords=background.widget_coords(strings.RADS2), text_function=lambda state: f"{state.rad_shield_percentage:,} %")
        ...
        widgets.SimpleText(self, coords=background.widget_coords(strings.RADAR), text_function=lambda _: strings.RADAR)
        widgets.SimpleText(self, coords=background.widget_coords(strings.FCELL_INJ), text_function=lambda _: strings.FCELL_INJ)
