...
1. Are you adding a piece of data that will not change during the runtime of
   ...
   For bonus points, expose this constant with an accessor in this file.
   Examples:
   - The name of an Coolant is exposed by CoolantView.name, which returns the
     correct name from strings.py.
...
2. Are you adding a piece of data that will change continuously during simulation,
   ...
   Again, adding an accessor like Entity.x will be useful.
