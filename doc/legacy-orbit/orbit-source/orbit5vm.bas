...
107     IF z$ = "t" THEN trail = 1 - trail: CLS : GOSUB 400
        ...
        if z$="#" then ii=targ:ij=28:im=300000:gosub 3101 'if z$="#" then ii=6:ij=33:im=P(6,5)*.25:gosub 3101:ii=11:ij=28:im=500000:gosub 3101
    
       
        IF z$ = "Y" THEN ii = 3: ij = 35: im = 365000: GOSUB 3101: ii = 3: ij = 32: im = 400000: GOSUB 3101
        IF z$ = "," THEN bkt = bkt - .1
        IF z$ = "." THEN bkt = bkt + .1
        IF z$ <> "/" THEN 104
